...
public interface SensorDataRepository extends JpaRepository<SensorData, String> {
    ...
    // Sostituito ObjectId con String
    List<SensorData> findAllByTimestampBetweenAndPayloadTypeAndSensorId(Date timestamp, Date timestamp2, @NotNull String sensorId, String id);

    // Sostituito ObjectId con String
    Optional<SensorData> findByIdAndSensorId(String id, @NotNull String sensorId);
