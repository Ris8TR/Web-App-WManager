...
public interface SensorService {
    ...
    List<SensorDto> getAllPublicSensor();
    ...
    List<SensorDto> findAllAdmin(String token);

    Optional<SensorDto> findByIdAdmin(String id);

    void deleteSensorByIdAdmin(String id);

    SensorDto updateAdmin(SensorDto sensorDto);
}
