...
export class SensorDataService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateSensorData(body: SensorData, observe?: 'body', reportProgress?: boolean): Observable<SensorData>;
    public updateSensorData(body: SensorData, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<SensorData>>;
    public updateSensorData(body: SensorData, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<SensorData>>;
    public updateSensorData(body: SensorData, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
